...
use App\Models\Others\Master\BusinessTypeMaster;
...
class BusinessTypeMasterController extends Controller
{
   ...
   public function index(Request $request){
      ...
      $posts = BusinessTypeMaster::when($Search, function ($query) use ($Search) {
      ...
      try{
          ...
          if($id == '') {
              ...
              if($validatordata->fails()){
               ...
               $savedata = BusinessTypeMaster::create([
                  'Name' => $request->Name,
  ...
  {
      $brands = BusinessTypeMaster::find($request->id);
      $brands->delete();
